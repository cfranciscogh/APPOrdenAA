		...
		resultado = $.parseJSON(data.d);
			...
			if ( resultado.length > 0 ){
				...
				for (var i = 0; i<resultado.length;i++){
					...
					$("#listProgramacion").append('<li><a data-ajax="false" href="detalle.html?orden='+ encodeURIComponent(resultado[i].orden) +'&cliente=' + encodeURIComponent(resultado[i].referencia_cliente) + '&ruc='+$.QueryString["ruc"]+'">'+ resultado[i].orden + '<br><span style=" font-weight:normal;">' + resultado[i].referencia_cliente +'</span></a></li> ');		
